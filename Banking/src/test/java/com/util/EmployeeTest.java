...
public class EmployeeTest {
	...
	final Employee emp1 = new Employee(101,"Seeta",14000);
	...
	@Mocked final EmployeeDao empDao,
	@Mocked final DBI dbi){
		new Expectations(){
			{
				result = empDao;					
			}
		...
		//Method mm = cc.getDeclaredMethods("dao");
		//mm.setAccessible(true);
		//EmployeeDao ed1 = cc.dao();
		//assertNotEquals(ed1,null);
	} 
